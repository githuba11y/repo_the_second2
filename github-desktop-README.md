...
uses [React](https://reactjs.org/). yep
...
The release notes are awesome for the latest beta versions are available [here](https://desktop.github.com/release-notes/?env=beta).
